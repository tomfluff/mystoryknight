...
const strings = {
  ...
  heroPending: {
    ...
    ja: "ヒーローをおはなしにごしょうたい中…",
    es: "Tu héroe está entrando en el cuento…",
  },
  heroFailed: {
  ...
  premiseNoteWaiting: {
    en: "The storyteller is thinking up beginnings for your hero. This can take up to a minute.",
    he: "מספר הסיפורים חושב על התחלות לגיבור שלכם. זה יכול לקחת עד דקה.",
    ja: "語りべがヒーローのはじまりをかんがえています。1分くらいかかることがあるよ。",
    es: "El narrador está pensando comienzos para tu héroe. Puede tardar hasta un minuto.",
  },
  openMenu: {
    en: "Open menu",
    he: "פתיחת התפריט",
